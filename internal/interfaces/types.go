...
// It defines common interface types used throughout the EVAS Proxy API for request and response
// transformation operations, maintaining compatibility with the SDK translator package.
package interfaces

import sdktranslator "github.com/ikiwihome/evas-api/v6/sdk/translator"
